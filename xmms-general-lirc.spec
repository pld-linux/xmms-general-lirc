...
Summary(pl.UTF-8):	Wtyczka LIRC (Zdalne sterowanie Linuksem za pomocą podczerwieni) dla XMMS-a
...
Ta wtyczka pozwala na zdalne sterowanie XMMS-em za pomocą LIRC.
